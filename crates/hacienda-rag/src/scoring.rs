...
//!
//! Recovered from `77e2fd3d71^:crates/xberg-rag/src/scoring.rs` (xberg, MIT).
//! Kept free of any backend dependency so the in-memory backend (and any
//! future backend) can share one implementation.
...
mod tests {
    ...
    #[test]
    fn should_compute_overlap_only_when_sparse_dot_has_shared_indices() {
    ...
    #[test]
    fn should_be_zero_when_sparse_dot_has_no_overlap() {
    ...
    #[test]
    fn should_be_zero_when_sparse_dot_inputs_are_empty() {
        assert_eq!(
            sparse_dot(&SparseVector::default(), &SparseVector::default()),
            0.0
        );
    }

    #[test]
    fn should_split_row_major_data_when_iterating_multi_vector_rows() {
    ...
    #[test]
    fn should_be_empty_when_multi_vector_dim_is_zero() {
        let v = mv(0, 0, &[]);
    ...
    #[test]
    fn should_match_hand_computed_value_when_max_sim_runs() {
    ...
    #[test]
    fn should_be_zero_when_max_sim_dims_mismatch() {
    ...
    #[test]
    fn should_be_zero_when_max_sim_inputs_are_empty() {
