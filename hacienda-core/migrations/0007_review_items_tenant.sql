...
-- 0005_audit_segments_tenant.sql / 0006_jobs_tenant.sql. The default is dropped in this
-- same migration: S1b's `ReviewStore` tenant threading ships in this change, so every
-- insert (all backends) already supplies `tenant_id` explicitly.
