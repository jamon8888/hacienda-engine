...
-- (spec §8) is built around, and lets existing INSERTs that don't yet name a tenant
-- keep working unchanged until the store layer threads a real TenantCtx through
