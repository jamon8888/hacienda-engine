...
CREATE TABLE IF NOT EXISTS audit_entries (
    ...
    action          TEXT NOT NULL,     -- Mask, Hash, Pseudonymize, Remove, Custom, Reveal
    span_hash       TEXT NOT NULL,     -- blake3(plaintext) hex
    span_length     BIGINT NOT NULL,
    confidence      DOUBLE PRECISION,
    source          TEXT NOT NULL,     -- Regex, Model, Custom
...
CREATE TABLE IF NOT EXISTS review_items (
    ...
    status          TEXT NOT NULL,     -- Pending, InReview, Approved, Rejected, Modified
